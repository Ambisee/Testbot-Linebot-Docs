...
export default function FormField(props) {
    ...
    const clearInput = () => {
        ...
        const target = document.querySelector(`.form-field > input[id=${props.name.toLowerCase()}]`);
        target.value = "";
        return;
    }
    ...
    return (
        <div className="form-field">
            <input id={props.name.toLowerCase()} name={props.name.toLowerCase()} type={hidePassword ? props.type : 'text'} required={true}></input>
